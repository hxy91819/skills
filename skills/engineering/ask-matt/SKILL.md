...
**`/setup-matt-pocock-skills`**: run before your first engineering flow. It derives the issue tracker, triage labels, and doc layout from the repo, writes them, and reports. Edit `docs/agents/` to override; custom issue trackers also work.
