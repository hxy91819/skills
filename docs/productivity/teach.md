...
| A factual answer or cited document rather than lessons | Ask for bounded primary-source research directly |
...
Its neighbour is [handoff](https://aihero.dev/skills-handoff): take a question into a teaching workspace, learn it there, and bring the answer back. For a cited factual answer rather than lessons and retention, request bounded research directly. [ask-matt](https://aihero.dev/skills-ask-matt) routes over the whole set.